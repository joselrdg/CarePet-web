...
export default class Demo extends React.PureComponent {
      ...
      resources: [
        {
          ...
          title: 'Location',
          instances: [
            { id: 'wash', text: 'Room caca' },
            { id: 'haircut', text: 'Room 2' },
            { id: 'Room 3', text: 'Room 3' },
            { id: 'Room 4', text: 'Room 4' },
            { id: 'Room 5', text: 'Room 5' },
          ],
  ...
  render() {
    const {
      currentDate, data, resources, mainResourceName, addedAppointment, appointmentChanges, editingAppointment,
    } = this.state;
